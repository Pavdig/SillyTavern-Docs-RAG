...
1. **Navigate to Character Folder**:
   - Go to the characters folder, e.g., `\SillyTavern\data\\characters\Seraphina`.
...
5. **Default Music Selection**:
   - When no emotion is detected, a random neutral track will play as the default. Emotions are detected similarly to updating sprites; refer to the [expression images documentation](SillyTavern_extensions_Expression-Images.md) for details.
...
1. **Navigate to BGM Folder**:
   - Go to the following folder: `\SillyTavern\data\\assets\bgm`.
...
1. **Navigate to Ambient Folder**:
   - Go to the following folder: `\SillyTavern\data\\assets\ambient`.
