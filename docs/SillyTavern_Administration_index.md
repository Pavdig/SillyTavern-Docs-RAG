...
A storage for [user account data](SillyTavern_Administration_multi-user.md).
...
10. Configure and enable [private address whitelisting](SillyTavern_Administration_config-yaml.md) to prevent SSRF attacks.
