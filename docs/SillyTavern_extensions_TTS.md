...
- **AllTalk** - free, open source local installation, offers a variety of TTS engines. See the [AllTalk](SillyTavern_extensions_AllTalk.md) page for setup instructions.
...
- **Google Gemini TTS** - requires an API key from either [Vertex AI](SillyTavern_Usage_API_Connections_google.md) or [AI Studio](SillyTavern_Usage_API_Connections_google.md), uses Gemini TTS (https://cloud.google.com/text-to-speech/docs/gemini-tts) models.
...
- **MiniMax** - requires an API key from MiniMax (https://www.minimax.io/). See the [MiniMax TTS](SillyTavern_extensions_MiniMaxTTS.md) page for setup instructions.
...
- **XTTS** - free, requires a dedicated API server installation. See the [XTTS](SillyTavern_extensions_XTTS.md) page for setup instructions.
