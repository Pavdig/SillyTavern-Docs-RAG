...
- **AllTalk** - free, open source local installation, offers a variety of TTS engines. See the [AllTalk](SillyTavern_AllTalk.md) page for setup instructions.
...
- **MiniMax** - requires an API key from MiniMax (https://www.minimax.io/). See the [MiniMax TTS](SillyTavern_MiniMaxTTS.md) page for setup instructions.
...
- **XTTS** - free, requires a dedicated API server installation. See the [XTTS](SillyTavern_XTTS.md) page for setup instructions.
