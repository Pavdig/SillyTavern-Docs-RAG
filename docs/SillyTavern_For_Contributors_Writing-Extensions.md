...
For a full guide including prerequisites, supported APIs, registration fields, and tips, see the dedicated [Function Calling](SillyTavern_For_Contributors_Function-Calling.md) page.
