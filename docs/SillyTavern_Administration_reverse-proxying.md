...
Token Permissions
    ...
    **Zone -> Zone -> Read**
on _Continue to summary_ followed by _Create Token._
...
to use the SillyTavern accounts as usernames and passwords:
