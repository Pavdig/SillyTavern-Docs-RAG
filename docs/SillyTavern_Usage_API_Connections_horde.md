...
- If you believe you received a malicious response, you can pass this information to the Horde admin on the AI Horde Discord for review and possible disciplinary action against that Worker.
...
- Register an account on the Horde website then add your Horde key into the SillyTavern Horde API Key box.
...
- If your GPU isn't powerful enough to run an AI, or you don't have a computer, you can still participate in the Horde community to earn Kudos in various ways.
