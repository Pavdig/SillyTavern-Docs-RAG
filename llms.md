...
A World Info file can be assigned to the currently active persona. The entries from this lorebook will be activated whenever that persona is selected, regardless of which character or chat is open.
...
**NOTE:** While editing the config you want to set listen to true if you haven't referenced from Remote Connections.
